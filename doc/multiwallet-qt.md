...
In order to support loading of multiple wallets in zaprex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zaprex.cpp.
...
Changes to zaprex.cpp
----------------------
zaprex.cpp is the entry point into zaprex-qt, and as such, will require some minor modifications to provide hooks for
