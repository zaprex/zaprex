...
This mechanism has been integrated into Bitcore-Node-Zaprex which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Zaprex-Project/insight-api-zaprex#web-socket-api](https://github.com/Zaprex-Project/insight-api-zaprex#web-socket-api) 
* API: [https://github.com/Zaprex-Project/insight-api-zaprex#swifttx-transactions](https://github.com/Zaprex-Project/insight-api-zaprex#swifttx-transactions) 
...
By default, the Zaprex Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zaprex Core daemon:
