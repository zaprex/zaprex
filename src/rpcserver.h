...
extern UniValue setzzpxseed(const UniValue& params, bool fHelp);
extern UniValue getzzpxseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzzpx(const UniValue& params, bool fHelp);
extern UniValue dzzpxstate(const UniValue& params, bool fHelp);
