...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zaprex features */
        {"zaprex", "masternode", &masternode, true, true, false},
        {"zaprex", "listmasternodes", &listmasternodes, true, true, false},
        {"zaprex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zaprex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zaprex", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"zaprex", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"zaprex", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"zaprex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zaprex", "masternodedebug", &masternodedebug, true, true, false},
        {"zaprex", "startmasternode", &startmasternode, true, true, false},
        {"zaprex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zaprex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zaprex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zaprex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zaprex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zaprex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zaprex", "mnbudget", &mnbudget, true, true, false},
        {"zaprex", "preparebudget", &preparebudget, true, true, false},
        {"zaprex", "submitbudget", &submitbudget, true, true, false},
        {"zaprex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zaprex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zaprex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zaprex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zaprex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zaprex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zaprex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zaprex", "checkbudgets", &checkbudgets, true, true, false},
        {"zaprex", "mnsync", &mnsync, true, true, false},
        {"zaprex", "spork", &spork, true, true, false},
        {"zaprex", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzzpxseed", &getzzpxseed, false, false, true},
        {"zerocoin", "setzzpxseed", &setzzpxseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzzpx", &searchdzzpx, false, false, true},
        {"zerocoin", "dzzpxstate", &dzzpxstate, false, false, true}
...
{
    return "> zaprex-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5801/\n";
}
