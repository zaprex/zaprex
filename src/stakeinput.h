...
#ifndef Zaprex_STAKEINPUT_H
#define Zaprex_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZZPX() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zZPXStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zzpx, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZZPX() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZZPX() override { return false; }
};


#endif //Zaprex_STAKEINPUT_H
