...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Zaprex Core zaprex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zaprex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zaprex transaction") + "\n" +
                               "  zaprex-tx [options] -create [commands]   " + _("Create hex-encoded zaprex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zaprex transaction
