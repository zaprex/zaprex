...
/* Zaprex GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Zaprex"
#define QAPP_ORG_DOMAIN "zaprex.org"
#define QAPP_APP_NAME_DEFAULT "Zaprex-Qt"
#define QAPP_APP_NAME_TESTNET "Zaprex-Qt-testnet"
