...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zzpxTracker->HasMintTx(hash))) {
            //zZPX stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZZPX;
...
bool IsZZPXType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZZPX:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZZPX || type == TransactionRecord::MNReward) {
