...
/** Utility functions used by the Zaprex Qt UI.
 */
namespace GUIUtil
{
...
// Render Zaprex addresses in monospace font
...
// Parse "zaprex:" URI into recipient object, return true on successful parsing
