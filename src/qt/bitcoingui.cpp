                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Zaprex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zaprex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zaprex: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zZPX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zaprex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zaprex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zaprex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zaprex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zaprex addresses"));
    ...
    openAction->setStatusTip(tr("Open a Zaprex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zaprex Core help message to get a list with possible Zaprex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Zaprex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zaprex network", "", count));
}
...
{
    QString strTitle = tr("Zaprex Core"); // default title
