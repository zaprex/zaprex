                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzZPXPathCustom = GetArg("-zzpxbackuppath", "");
    ...
    if(!strzZPXPathCustom.empty()) {
        ui->wallet_customzzpxbackuppath->setText(QString::fromStdString(strzZPXPathCustom));
        ui->wallet_customzzpxbackuppath_label->setVisible(true);
        ui->wallet_customzzpxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzZPXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Zaprex RPC console.") + "<br>" +
