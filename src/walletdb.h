...
public:
    ...
    bool WriteZZPXSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZZPXSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZZPXSeed_deprecated(uint256& seed);
    bool EraseZZPXSeed();
    bool EraseZZPXSeed_deprecated();

    bool WriteZZPXCount(const uint32_t& nCount);
    bool ReadZZPXCount(uint32_t& nCount);
