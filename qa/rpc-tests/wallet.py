...
#   c) node1 mines 32 blocks, so now node 0 has 60001zpx, node 1 has 4250zpx, node2 has none.
#   d) node0 sends 601 zpx to node2, in two transactions (301 zpx, then 300 zpx).
