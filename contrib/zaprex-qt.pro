...
RESOURCES += src/qt/zaprex.qrc src/qt/zaprex_locale.qrc

TRANSLATIONS += src/qt/locale/zaprex_bg.ts \
                src/qt/locale/zaprex_de.ts \
                src/qt/locale/zaprex_en.ts \
                src/qt/locale/zaprex_es.ts \
                src/qt/locale/zaprex_fi.ts \
                src/qt/locale/zaprex_fr.ts \
                src/qt/locale/zaprex_it.ts \
                src/qt/locale/zaprex_ja.ts \
                src/qt/locale/zaprex_pl.ts \
                src/qt/locale/zaprex_pt.ts \
                src/qt/locale/zaprex_ru.ts \
                src/qt/locale/zaprex_sk.ts \
                src/qt/locale/zaprex_sv.ts \
                src/qt/locale/zaprex_vi.ts \
                src/qt/locale/zaprex_zh_CN.ts \
                src/qt/locale/zaprex_zh_TW.ts
