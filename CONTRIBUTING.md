Contributing to Zaprex Core
============================

The Zaprex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zaprex Core project, and is not to be
confused with overall Zaprex Network Protocol consensus changes.

Whether a pull request is merged into Zaprex Core rests with the project merge
...
Patches that change Zaprex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zaprex consensus, it must have been
...
The project leader is the release manager for each Zaprex Core release.
